...
The output of first line of code is not printed out because itt is assigned to a variable instead.

The second line of output is printed out instead, but this means that the calculated value has been saved for future use.
